...
public class MCreatorReinforceASword extends Elementsexample_mod.ModElement {
	public static final CustomAdvancementTrigger trigger = new CustomAdvancementTrigger();

	public MCreatorReinforceASword(Elementsexample_mod instance) {
		super(instance, 3);
	}
	...
	public static class CustomAdvancementTrigger implements ICriterionTrigger {
		...
		public ResourceLocation getId() {
			return new ResourceLocation("reinforceasword");
		}
